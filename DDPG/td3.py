...
class TD3:
    def __init__(self, dim_state, dim_action, max_action):
        ...
        self.max_action = max_action
        self.Q1 = QNet(dim_state, dim_action)  #critic1
        self.Q2 = QNet(dim_state, dim_action)  #critic2
        self.Mu = PolicyNet(dim_state, dim_action, max_action) #actor
...
def main():
    ...
    parser.add_argument("--output_dir", default="output/td3", type=str, help="Output directory.")
